...
use Payment\Http\Adapter\Curl\AbstractCurl;
use Payment\Http\Adapter\Curl\Curl;
use Payment\Http\Adapter\Curl\CurlInterface;
...
use Payment\Exception\Exception;
