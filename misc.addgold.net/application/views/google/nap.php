...
<div class="wrap-content">
    ...
    <div id="group-card" class="choice-list">
        <form id="submitCard" action="/topup" style="display: inline-block">
                                    ...
                                    <div class="cover-image-container-telco">
                                        <div class="cover-outer-align-telco">
                                            <div class="cover-inner-align-telco">
                                                <label>
                                                    <input type="radio" name="cardType" class="required rdiexchange"
            ...
            <div class="choice-item">
                <span class="choice-value"><span style="line-height: 24px">Thẻ Viettel có thể nạp trực tiếp tại đây vào các game của Làng Game</span></span>
            </div>
            <div class="card-info">
                <div class="choice-item">
                    ...
                    <div id="exchangeList" class="exchange-list">
                        ...
                        if (is_array($exchangeRate)) {
                            foreach ($exchangeRate as $key => $value) {
                                ...
                                <div class="row-tr">
                                    <div class="row-td"><span>  <?php echo $value["sub_name"] ?></span>
                                    </div>
                ...
                <div class="giftcode-info">
                    <div class="item-list">
                        ...
                        <ul id="home_item_container" class="clearfix">
                            ...
                            <li id="home_item_10" orderdata="00" class="col-xs-6 col-sm-4 col-md-4 col-lg-4 " style="">
                                <p class="pic">
                                ...
                                <div class="desc clearfix">
                                    ...
                                    <div class="info">
                                        ...
                                        ?>
                                                <span class="btn-button exec_giftcode" hashdata="<?php echo $value['hashdata'] ?>">Nhận giftcode</span>
                                        <?php
                                            }else{
                                        ?>
