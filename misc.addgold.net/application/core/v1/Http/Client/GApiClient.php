...
class GApiClient extends Client implements ClientInterface {
    ...
    public function getToken(RequestInterface $request) {
        ...
        //echo implode("", $params) . $this->secret, "<br>";
    ...
    public function verifyCard(array $params) {
        ...
        $response = $this->getApi()->call(array("control" => "paycard", "func" => "pay_card"), "GET", $params);
        return $response;
    }
     ...
     * @throws \Exception
     */
    public function getUserInfo($service_name, $account_id, $server_id,$account_name = null) {
...
//            'Minus item failed is class ' . get_class($this) . ' position function ' . __FUNCTION__);
    ...
    public function addMoney($params) {
        ...
        $params["game_info"] = isset($params["info"]) ? $params["info"] : $params["game_info"];
        unset($params["info"]);

        //send request to server
        return $this->getApi()->call(array("control" => "payment", "func" => "recharge"), "GET", $params);
    }
